...
.cls1{text-align:center; font-size:30px;}
</style>
</head>
<script>
...
<tr height="10" allign="center" bgcolor="ligntgreen">
<td>글번호</td>
<td>작성자</td>
<td>제목</td>
<td>작성일</td>
...
<td colspan="4">
<p align="center">
<b><span style="font-size:9pt;">등록된 글이 없습니다.</span></b></p>
</td>
</tr>
</c:when>
<c:when test="${!empty articlesList}">
...
<c:choose>
<c:when test="${totAricles > 100 }"> <!-- 글 개수가 100 초과인 경우 -->
...
<c:forEach var="page" begin="1" end="${totAricles/10 +1}" step="1">
<c:choose>
...
<br><br>
<a class="cls1" href="${contextPath}/board/articleForm.do"><p class="cls2">글쓰기</a></p>
