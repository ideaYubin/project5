/*
 * package com.myspring.pro28.ex01; import java.io.File; import
 * java.util.ArrayList; import java.util.Enumeration; import java.util.HashMap;
 ...
 * 
 * @RequestMapping(value="/form") public String form() { return "uploadForm"; }
 * 
 * @RequestMapping(value = "/upload", method = RequestMethod.POST) public
 * ModelAndView upload(MultipartHttpServletRequest multipartRequest,
 * HttpServletResponse response) throws Exception {
 * multipartRequest.setCharacterEncoding("utf-8"); Map map = new HashMap();
 * Enumeration enu = multipartRequest.getParameterNames(); while
 * (enu.hasMoreElements()) { String name = (String)enu.nextElement(); String
 * value = multipartRequest.getParameter(name); System.out.println(name + ", " +
